...
private const val xRange: Int = 148*4
...
class Fragment2 : Fragment() {
    ...
    private var reDrawer2: Redrawer? = null
    private var timeCompleteRequired: Double = 4.0
...
//    Data Manipulation of Different Plots
        ...
        for (i in ecgData1.indices) {ecgData1[i] = ecgData1[i] / 3}
        val ecgData2: Array<Int> = ecgData1.copyOf()
...
//    Used to redraw the plot at a specific refresh rate, maxRefreshRate is in millisecond
        reDrawer2 = Redrawer(plot, 50f, true)
    }
